...
<body>
	<header id="header">
		<hgroup>
			...
			<h2 class="section_title"><a class="tjgk bq load" href="system/settings">系统设置</a><a class="tjgk bq load" href="member/bank">银行信息</a><a class="tjgk bq load" href="system/bank">收款设置</a><a class="tjgk bq load" href="member/index">用户列表</a><a class="tjgk bq load" href="member/loginLog">登陆记录</a><a class="tjgk bq load" method="post" target="ajax" call="clearDataSuccess" title="即将清空程序缓存，是否继续！" dataType="json" href="/index.php/clear/rmfile">清空缓存</a>
            </h2>
